...
chi hoan doi vi tri item va user trong function read_data => transform user-user CF to item-item CF
"""
...
def read_data(path):
    ...
    for user_id, movie_id, rating, timestamp in data:
        user_ids.append(int(movie_id))
        movie_ids.append(int(user_id))
